...
const LoginAndRegister = ({ setIsAuthenticated }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const url = isLogin ? `${process.env.REACT_APP_BACKEND_URL}/login` : `${process.env.REACT_APP_BACKEND_URL}/register`;
...
const styles = {
  container: {
    ...
    color: "#000000",
    textAlign: "center",
    backgroundImage: `url(${'https://wallpapercave.com/wp/wp6938358.jpg'})`,
